...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CropCare — Smart Crop Management" },
      { name: "description", content: "Manage crops, watering, pesticides, growth and harvest. Smart agricultural management system." },
      { property: "og:title", content: "CropCare — Smart Crop Management" },
      { property: "og:description", content: "Full-lifecycle crop management with automated schedules and analytics." },
